...
params["training"]["num_reference_molecules"] = 1
...
params["training"]["sampling_gpu_ids"] = [0, 1, 2]
params["training"]["num_workers"] = 2
params["training"]["output_dir"] = "x1x3x4_dpo_finetune_nps"
params["training"]["log_every_n_steps"] = 10
params["training"]["checkpoint_every_n_epochs"] = 1

params["sampling"] = {
    "num_samples_per_molecule": 24,
    "inference_sub_batch_size": 8,
    "fixed_n_atoms": 78,
}
