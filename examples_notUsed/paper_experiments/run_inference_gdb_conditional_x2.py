...
chkpt = '../../data/shepherd_chkpts/x1x2_diffusion_gdb17_20240824_submission.ckpt'
...
with open(f'../../data/conformers/gdb/molblock_charges_9_test100.pkl', 'rb') as f:
...
for k in range(len(molblocks_and_charges)):
    ...
    with open(f"samples/GDB_conditional/x2/samples_{k}.pickle", "wb") as f:
