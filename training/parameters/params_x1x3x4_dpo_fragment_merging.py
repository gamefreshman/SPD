# DPO微调配置 - Fragment Merging
# 使用fragment_merge_condition.pickle作为条件输入
...
params = {
    'data': 'fragment_merging',  # 使用Fragment Merging条件数据
    ...
    'training': {
        ...
        'output_dir': 'x1x3x4_dpo_fragment_merging/',  # Fragment Merging专门的输出目录
        ...
        # DPO核心参数
        'beta_dpo': 0.25,  # DPO温度参数，稍高以鼓励探索
        'dpo_ramp_up_epochs': 5,  # 预热轮数
