...
params = {
    ...
    'training': {
        ...
        'output_dir': 'x1x3x4_dpo_finetune_pdb/',  # PDB专门的输出目录
        ...
        'dpo_ramp_up_epochs': 3,  # 预热轮数
        'dpo_max_weight': 0.5,  # DPO最大权重
        
        # 采样策略（针对PDB数据集调整）
        'dpo_sampling_ratio': 0.1,  # 每个epoch采样10%
        'dpo_batch_ratio': 0.4,  # DPO batch占总batch的40%
