# SPD 基模型重训配置 — 使用 v1.9 修复后的推理代码
# 基于 params_x1x3x4_diffusion_mosesaq_20240824.py，关闭 DPO，从头训练
...
params = {
    ...
    'training': {
        ...
        'output_dir': 'x1x3x4_diffusion_mosesaq_retrain/',
        ...
        # ==================== DPO 配置（禁用）====================
        'enable_dpo': False,  # 纯标准去噪训练，不启用 DPO
    },
