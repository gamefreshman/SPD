# v2.0 Partial Denoising DPO — 基于3个天然产物分子（NPs）
# 核心变更：从 GT 前向加噪 t=0.5 出发降噪，缩小优化空间
...
params = {
    ...
    'training': {
        ...
        'output_dir': 'x1x3x4_dpo_partial_denoise_nps/',  # v2.0 Partial Denoising 输出目录
    ...
    'sampling': {
        ...
        'partial_denoise_t_start': 0.5,  # 从 GT 前向加噪到 t=0.5 出发降噪（None=禁用，从纯噪声开始）
    },
