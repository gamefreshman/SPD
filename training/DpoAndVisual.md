...
| 配置项 | v1.5 | v1.6 | v1.7 | v1.8 |
|--------|------|------|------|------|
| beta_dpo | 0.1 | 0.3 | 0.1 | 0.1 |
| dpo_max_weight | 0.8 | 0.3 | 0.3 | 0.3 |
| dpo_ramp_up_epochs | 3 | 10 | 10 | 10 |
| real_data_ratio | — | — | 0.5 | 0.5 |
| iterative_dpo_enabled | True | True | True | **False** |
| x4 DPO Loss | 无 | 有 | 有 | 有 |
| SA 惩罚权重 | ×0.5 | ×1.5 | ×1.5 | ×1.5 |
...
| 版本 | 日期 | 标签 | 状态 | 简要描述 |
|------|------|------|------|----------|
| v1.9.1 | 2026-03-27 | `[Bug修复]` | 待验证 | 修复 v1.9 引入的 prob_X 归一化断言失败（[BF-001](../.Project/bugfix_log.md#bf-001-prob_x-归一化断言失败)） |
| v1.9 | 2026-03-27 | `[Bug修复]` | 待验证 | 修复离散扩散推理 6 个 Bug：x4 后验采样、初始噪声、pharm_diffuser 基础设施（[BF-002](../.Project/bugfix_log.md#bf-002-离散扩散推理-6-个关键-bug)） |
